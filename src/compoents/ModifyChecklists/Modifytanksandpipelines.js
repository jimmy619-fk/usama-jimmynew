...
export default function Modifytanksandpipelines() {
  ...
  let muFun = (formData) => {
    axios.post("/QuestionOfTankandPipelineAfterChange", Ques).then((abc) => {
      myAlert(abc.data);
    });

    axios.post("/ChecklistChangingRecord", {
      Data: "Tank&Pipeline List Changed By " + Dats.Name,
    });
  };
