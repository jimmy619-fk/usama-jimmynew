...
export default function Modifymotorandpump() {
  ...
  let muFun = (formData) => {
    console.log(Ques);
    axios.post("/QuestionOfMotorAndPumpAfterChange", Ques).then((abc) => {
    ...
    axios.post("/ChecklistChangingRecord", {
      Data: "Motor and Pump List Changed By " + Dats.Name,
    });
  };
                    ...
                    <thead>
                      <tr>
                        ...
                        <th className="widthkum">
                          ...
                          {/* <img    onClick={AddingRow}  src="plus-sign.png" alt="" /> */}
                        </th>
                      </tr>
                    </thead>
                        ...
                        return (
                          <tr className="rowkodarmyanmaykro">
                            ...
                            <td>
                              ...
                              {/* <img   onClick={ManageDelete} value={indx}  src="delete.png" alt="" /> */}
                            </td>
                          </tr>
                        );
                      })}
