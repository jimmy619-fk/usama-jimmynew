...
export default function Firepumpdata() {
  let [Data, SetData] = useState([]);

  useEffect(() => {
    axios
      .post("/showFireMonthlyPumpdata")
      .then((xyz) => {
        console.log("fire pump monthly history", xyz.data);
        SetData(xyz.data);
      })
      .catch((error) => {
            ...
            <div>
              <div className="contentvalvescard">
                ...
                <div className="cardhsdmsd">
                  ...
                  <p className="title">Fire pump</p>
                  {/* <Link to="/loadingarmsdata">
                    {" "}
                      ...
                      <>
                        <tr className="#00c853 green accent-4">
                          <td>
                            ...
                            <p>
                              <b>FirePump Number(#): {val.PumpType}</b>
                            </p>
                            <p>
