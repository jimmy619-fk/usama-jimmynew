...
// Motorms
export default function LoadingArms() {
  ...
  useEffect(async () => {
    let resp = await axios.post("/loadingarmsQuestion");
    SetQues(resp.data[0].LoadingArms);
      ...
      <div id="dataha" ref={printingData}>
        ...
        <div className="selectmotortyp">
          <div class="input-field col s6 selectwala">
            <select ref={formRef}>
              <optgroup label="LOADINGARMS">
                <option value="LOADINGARMS 1  ">LOADINGARMS 1</option>
                <option value="LOADINGARMS 2  ">LOADINGARMS 2</option>
                <option value="LOADINGARMS 3  ">LOADINGARMS 3</option>
                <option value="LOADINGARMS 4  ">LOADINGARMS 4</option>
              </optgroup>
            </select>
            <label>Select Loading-Arms</label>
            <ReactToPrint
              trigger={() => (
